...
<head>
    ...
    <script src="https://unpkg.com/alpinejs" defer></script> <!-- Tambah AlpineJS -->
</head>
<body>
<nav class="sticky top-0 z-10">
    <div class="bg-[#2F81DF] flex justify-between p-0 m-0">
        <div class="flex items-center text-[2.5rem] text-white">
            <img src="{{ asset('img/footer.png') }}" alt="nav" class="w-24 h-17 m-5 ml-20 p-0">
            SKIL
        </div>
        <div class="flex items-center text-2xl mr-5 gap-20 text-white">
            ...
            <div x-data="{ open: false }" class="relative inline-block text-left">
                <a href="#" @click.prevent="open = !open" class="flex items-center">
